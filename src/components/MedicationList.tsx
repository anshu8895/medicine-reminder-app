...
import type { MedicationListProps, ReminderItemProps } from "../types";

export default function MedicationList({ reminders, onDelete, onEdit, markAsTaken, snoozedItemIds }: MedicationListProps) {
...
function ReminderItem({ reminder, onDelete, onEdit, markAsTaken, isSnoozed }: ReminderItemProps) {
    const [isEditing, setIsEditing] = useState<boolean>(false);
    const [medicineName, setMedicineName] = useState<string>(reminder.medicineName);
    const [medicineTime, setMedicineTime] = useState<string>(reminder.medicineTime);
